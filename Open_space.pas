...
begin
  ...
  begin
    buttonSelected := MessageDlg('Вы уверены в том, что хотите выйти из приложения Office?'+#10+'У вас открыт графический или текстовый редактор, изменения не сохранятся!',mtWarning , mbOKCancel, 0);
...
begin
  SetForegroundWindow(FindWindow('TForm2','Заголовок'));
end;
